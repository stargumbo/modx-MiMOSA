...
- Disable weekdays: 1,2,3,4,5',
  ...
  'resourcelist_where_desc' => 'A JSON object of where conditions to filter by in the query that grabs the list of Resources. (Does not support TV searching.)<br/>Examples: [{"template:=":"4"}], [{"pagetitle:!=":"Home"}], [{"parent:IN":[34,56]}]',
  'richtext' => 'RichText',
