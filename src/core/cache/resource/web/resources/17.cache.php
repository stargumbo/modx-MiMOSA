<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1479536267,
    'editedby' => 2,
    'editedon' => 1491492583,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1479536220,
    'publishedby' => 2,
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsicbssportsfantasyapp, cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsicbssportsfantasyapp-dev, cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>CBS Sports Fantasy App - MiMOSA</title>
...
<pre class="line-numbers"><code class="language-objectivec">NSDictionary *cdata = @{
    @"siteCode": @"cbssports",
    @"sitePrimaryRsid": @"cbssportsfantasyapp",
    @"siteType": @"native app",
...
<li class="active"><a href="groups/" title="Groups" class=\'linkdisable\'>Groups</a><ul><li class="first active"><a href="cdm/" title="CDM" class=\'linkdisable\'>CDM</a><ul><li class="first active"><a href="sports/" title="Sports" >Sports</a><ul><li class="first"><a href="cbs-sports/" title="CBS Sports" >CBS Sports</a></li>
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>CBS Sports Fantasy App Tracking</h2>
            <p>This is the tracking spec for CBS Sports Fantasy App Tracking using the latest tracking implementation for -</p>
            <ul>
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsicbssportsfantasyapp, cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
   ...
   "privacyDefault" : "optedin"
                    ...
                    <p>For production environment, change rsids to "cbsicbssportsfantasyapp, cbsicbsiall"</p>
                    <p>All test builds should use "cbsicbssportsfantasyapp-dev, cbsicbsiall-dev"</p>
                </div>
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>The value will be either "cbssportsfantasyapp" or "cbssportsfantasyapp-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
...
Analytics.trackState("screenName", cdata);</code></pre></div>
        ...
        <div class="aside">
            ...
            <ul>
                ...
                <li>Prod RSIDs:<br /><em>cbsicbssportsfantasyapp, cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsicbssportsfantasyapp-dev, cbsicbsiall-dev</em></li>
...
<script type="text/javascript">
    ...
    '[[$basicHead]]' => '    <title>CBS Sports Fantasy App - MiMOSA</title>
