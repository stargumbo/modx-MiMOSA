<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1497971390,
    'editedby' => 2,
    'editedon' => 1498067909,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1497971340,
    'publishedby' => 2,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'appfeatures',
      1 => 'Articles||Events||Interaction (Login)||Click Tracking||Video||MVPD',
      2 => 'default',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
...
/* http://prismjs.com/download.html?themes=prism-coy&languages=markup+css+clike+javascript+c+java+json+objectivec&plugins=line-highlight+line-numbers+keep-markup */
/**
...
.line-numbers .line-numbers-rows {
    ...
    "pagename" : "{{this.gsx$pagename.$t}}"{{/if}}{{#if this.gsx$pageviewguid.$t}}
...
cdata.put("pagename", "{{this.gsx$pagename.$t}}";{{/if}}{{#if this.gsx$pageviewguid.$t}}
...
<li><a href="college-sports/" title="College Sports" >College Sports</a></li>
...
<li class="last active"><a href="entertainment/" title="Entertainment" class=\'linkdisable\'>Entertainment</a><ul><li class="first active"><a href="cbs/" title="CBS.com" >CBS.com</a></li>
</ul></li>
</ul></li>
...
<p>Upon successful login send the following tracking call. This call should be made in context to the screen that the call was triggered from.</p>
    ...
    siteCode : "[[*siteCode]]",
    sitePrimaryRsid : "[[*sitePrimaryRsid]]",
    siteType": "[[*siteType]]",[[If? &subject=`[[*mvt_override]]` &operator=`notempty` &then=`` &else=`
    siteSection": "project|channel|product/event|service level|feature|sub-feature",
    siteHier": "project|channel|product/event|service level|feature|sub-feature",
    pageType": "[pageType]",`]]
    screenName": "[screenName]"
...
cdata.put("sitePrimaryRsid", "[[*sitePrimaryRsid]]");
cdata.put("siteType", "[[*siteType]]");[[If? &subject=`[[*mvt_override]]` &operator=`notempty` &then=`` &else=`
cdata.put("siteSection", "project|channel|product/event|service level|feature|sub-feature");
cdata.put("siteHier", "project|channel|product/event|service level|feature|sub-feature");
cdata.put("pageType", "[pageType]");`]]
cdata.put("screenName", "[screenName]");
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'type' => 'checkbox',
          'name' => 'mvt_override',
          'caption' => 'MVT (Minimum Viable Tracking)',
          'description' => '',
          'editor_type' => 0,
          'category' => 6,
          'locked' => false,
