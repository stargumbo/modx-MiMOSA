<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'appfeatures',
      1 => 'Articles||Events||Interaction (Login)||Click Tracking',
      2 => 'default',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
    ...
    array (
      0 => 'gen_ontologyID',
      1 => '1vOadugEJE5vkFdFQzocACUHsreqHClNfEMUxMKZreI8',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsicbssportsdraftmasterapp,cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsicbssportsdraftmasterapp-dev,cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>DraftMaster App - MiMOSA</title>
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p>Along with the visitor ID, we will need to append <em>cbsicbssportsdraftmasterapp</em> to the apprsid parameter in the URL.</p>
                    <p><strong>Webview Embed URL -</strong><br />{{contains this.gsx$webviewurl.$t}}adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsicbssportsdraftmasterapp</p>
                </div>
                {{else}}
...
<script type="text/javascript">
    // JSON feed
    var feed = "";
    var url = "https://spreadsheets.google.com/feeds/list/1vOadugEJE5vkFdFQzocACUHsreqHClNfEMUxMKZreI8/od6/public/values?alt=json";
...
<li class="active"><a href="groups/" title="Groups" class=\'linkdisable\'>Groups</a><ul><li class="first active"><a href="cdm/" title="CDM" class=\'linkdisable\'>CDM</a><ul><li class="first active"><a href="sports/" title="Sports" class=\'linkdisable\'>Sports</a><ul><li class="first"><a href="cbs-sports/" title="CBS Sports" >CBS Sports</a></li>
<li class="active"><a href="cbs-sports-fantasy/" title="CBS Sports Fantasy" >CBS Sports Fantasy</a></li>
...
<div class="content">
    <div class="container">
        <div class="main">
[[@RESOURCE 92]]
            <h2>DraftMaster App Tracking</h2>
            <p>This is the tracking spec for DraftMaster App Tracking using the latest tracking implementation for -</p>
            <ul>
                <li>Web</li>
                <li>Android</li>
                <li>iOS</li>
            </ul>
            <!-- <p>The JIRA ticket for this project is at <a href="https://owl.cbsi.com/jira/browse/DSSCDM-138" target="_blank">https://owl.cbsi.com/jira/browse/DSSCDM-138</a></p> -->
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsicbssportsdraftmasterapp,cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
   ...
   "privacyDefault" : "optedin"
                    ...
                    <p>For production environment, change rsids to "cbsicbssportsdraftmasterapp,cbsicbsiall"</p>
                    <p>All test builds should use "cbsicbssportsdraftmasterapp-dev,cbsicbsiall-dev"</p>
                </div>
            ...
            <h3>Web Tracking Implementation</h3>
            <div class="accordion accordion4">
                ...
                <div class="inner-container">
                    ...
                    <pre id="ADBMobilejs" class="line-numbers"><code class="language-markup">&lt;script type="text/javascript"&gt;
    var utag_data={};
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>siteCode</td>
                                        <td>This key should always be set to the value "cbssports"</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>The value will be either "cbsicbssportsdraftmasterapp" or "cbsicbssportsdraftmasterapp-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
 ...
 "analytics" : {
   ...
   "privacyDefault" : "optedin"
        ...
        <div class="aside">
            ...
            <ul>
                <li>Site Code:<br /><em>cbssports</em></li>
                <li>Site Type:<br /><em>native app</em></li>
                <li>Prod RSIDs:<br /><em>cbsicbssportsdraftmasterapp,cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsicbssportsdraftmasterapp-dev,cbsicbsiall-dev</em></li>
                <!-- <li>JIRA Ticket(s):<br /><em>https://owl.cbsi.com/jira/browse/DSSCDM-138</em></li> -->
            </ul>
        </div>
    </div>
</div>
...
',
    '[[$basicHead]]' => '    <title>DraftMaster App - MiMOSA</title>
