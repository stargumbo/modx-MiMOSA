<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'featuretracking',
      1 => 'Photo Gallery||User Authentication State||In-App Billing||Internal Campaign Attribution||Login||MVPD||Pod||Registration||Search||Setting pageViewGuid||Show Browse Filter',
      2 => 'default',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p><strong>Webview Embed URL -</strong><br />{{this.gsx$webviewurl.$t}}&amp;adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsicbsapp</p>
                </div>
                {{else}}
...
<p>
   ...
   [ADBMobile trackState:@"/shows/the amazing race/photos/1004671/", data:cdata];<br />
                ...
                <!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
<p>
   ...
   [ADBMobile trackState:@"/shows/the amazing race/photos/1004671/", data:cdata];<br />
    ...
    '[[$ft_user_auth_state? &name=`User Authentication State`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`User Authentication State`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
                ...
                <div class="inner-container">
                    ...
                    <p>Refer to the Analytics section of the SDK doc (<a href="[[*AndroidSDK]]" target="_blank">Android</a>
                        <a href="[[*iOSSDK]]" target="_blank">iOS</a>) for more information.</p>
                </div>`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[$ft_setting_pageviewguid? &name=`Setting pageViewGuid`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Setting pageViewGuid`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_login? &name=`Login`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Login`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_registration? &name=`Registration`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Registration`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_pod? &name=`Pod`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Pod`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_mvpd? &name=`MVPD`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`MVPD`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_inapp_billing? &name=`In-App Billing`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`In-App Billing`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_search? &name=`Search`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Search`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_internal_campaign_attr? &name=`Internal Campaign Attribution`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Internal Campaign Attribution`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
...
Test paragraph text
    ...
    '[[$ft_show_browse_filter? &name=`Show Browse Filter`]]' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
    ...
    '[[*featuretracking:contains=`Show Browse Filter`:then=`<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
   ...
   [ADBMobile trackState:@"/shows/the amazing race/photos/1004671/", data:cdata];<br />
      ...
      array (
        ...
        array (
          ...
          'category' => 41,
          'cache_type' => 0,
          'snippet' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<!--<h3 style="margin:0;">Test Heading</h3>
<p>
Test paragraph text
</p>-->
