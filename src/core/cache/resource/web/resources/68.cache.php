<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 7,
    'createdon' => 1493135495,
    'editedby' => 7,
    'editedon' => 1493330444,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1493118660,
    'publishedby' => 7,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsicnetglobalsite, cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsicnetglobalsite-dev, cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>Cnet.com - MiMOSA</title>
...
.line-numbers-rows > span:before { content:counter(linenumber); color:#999; display:block; padding-right:0.8em; text-align:right; }
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p><strong>Webview Embed URL -</strong><br />{{this.gsx$webviewurl.$t}}&amp;adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsicnetglobalsite</p>
                </div>
                {{else}}
    ...
    siteCode : \'cnet\'
    sitePrimaryRsid : \'cbsicnetglobalsite\'
...
<li class="active"><a href="groups/" title="Groups" class=\'linkdisable\'>Groups</a><ul><li class="first"><a href="cdm/" title="CDM" class=\'linkdisable\'>CDM</a><ul><li class="first"><a href="sports/" title="Sports" class=\'linkdisable\'>Sports</a><ul><li class="first"><a href="cbs-sports/" title="CBS Sports" >CBS Sports</a></li>
...
<li class="last active"><a href="cmg/" title="CMG" class=\'linkdisable\'>CMG</a><ul><li class="first"><a href="b2b/" title="b2b" class=\'linkdisable\'>b2b</a><ul><li class="first"><a href="techrepublic/" title="TechRepublic" >TechRepublic</a></li>
...
<li class="active"><a href="media/" title="Media" class=\'linkdisable\'>Media</a><ul><li class="first active"><a href="cnet/" title="CNET" >CNET</a></li>
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>Cnet.com</h2>
            <p>This is the tracking spec for Cnet.com using the latest tracking implementation for -</p>
            <ul>
                <li>Web</li>
...
&lt;/script&gt;
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>siteCode</td>
                                        <td>This key should always be set to the value "cnet"</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>The value will be either "cbsicnetglobalsite" or "cbsicnetglobalsite-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
    ...
    screenName": "[screenName]"
        ...
        <div class="aside">
            ...
            <ul>
                <li>Site Code:<br /><em>cnet</em></li>
                <li>Site Type:<br /><em>desktop web</em></li>
                <li>Prod RSIDs:<br /><em>cbsicnetglobalsite, cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsicnetglobalsite-dev, cbsicbsiall-dev</em></li>
                <!--  -->
            </ul>
        </div>
    </div>
...
<pre class="line-numbers"><code class="language-java">cdata.put("siteCode", "cnet");
cdata.put("sitePrimaryRsid", "cbsicnetglobalsite");
...
',
    '[[$basicHead]]' => '    <title>Cnet.com - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsicnetglobalsite, cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
...
[ADBMobile trackState:@"screenName", data:cdata];</code></pre></div>',
    '[[$base_codeFormat_android]]' => '<div id="tab102" class="tab"><h3 style="margin:0;">Android Data Object</h3><pre class="language-java line-numbers"><code class="language-java">cdata.put("siteCode", "cnet");
cdata.put("sitePrimaryRsid", "cbsicnetglobalsite");
cdata.put("siteType", "desktop web");
