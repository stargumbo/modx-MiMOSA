<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'appfeatures',
      1 => 'Articles||Events||Interaction (Login)||Click Tracking||Video',
      2 => 'default',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
    ...
    array (
      0 => 'gen_ontologyID',
      1 => '1A_P8i6-tk19Pfc-zFkvNFx0OyxCLgd8vgANMFsPVJ3s',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsicbssportsapp,cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsicbssportsapp-dev,cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>CBSSports - MiMOSA</title>
...
.line-numbers-rows > span:before { content:counter(linenumber); color:#999; display:block; padding-right:0.8em; text-align:right; }
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p>Along with the visitor ID, we will need to append <em>cbsicbssportsapp</em> to the apprsid parameter in the URL.</p>
                    <p><strong>Webview Embed URL -</strong><br />{{contains this.gsx$webviewurl.$t}}adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsicbssportsapp</p>
                </div>
                {{else}}
    ...
    <pre class="line-numbers"><code class="language-json">    "siteCode" : "cbssports"
    "sitePrimaryRsid" : "cbsicbssportsapp"
...
cdata.put("sitePrimaryRsid", "cbsicbssportsapp");
...
<li class="active"><a href="groups/" title="Groups" class=\'linkdisable\'>Groups</a><ul><li class="first active"><a href="cdm/" title="CDM" class=\'linkdisable\'>CDM</a><ul><li class="first active"><a href="sports/" title="Sports" class=\'linkdisable\'>Sports</a><ul><li class="first active"><a href="cbs-sports/" title="CBS Sports" >CBS Sports</a></li>
...
<div class="content">
    <div class="container">
        <div class="main">
[[@RESOURCE 92]]
            <h2>CBS Sports App Tracking</h2>
            <p>This is the tracking spec for CBS Sports App Tracking using the latest tracking implementation for -</p>
            <ul>
                
                <li>Android</li>
                <li>iOS</li>
            </ul>
            <!-- <p>The JIRA ticket for this project is at <a href="https://owl.cbsi.com/jira/browse/OMNITURE-590" target="_blank">https://owl.cbsi.com/jira/browse/OMNITURE-590</a></p> -->
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsicbssportsapp,cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
   ...
   "privacyDefault" : "optedin"
                    ...
                    <p>For production environment, change rsids to "cbsicbssportsapp,cbsicbsiall"</p>
                    <p>All test builds should use "cbsicbssportsapp-dev,cbsicbsiall-dev"</p>
                </div>
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>The value will be either "cbsicbssportsapp" or "cbsicbssportsapp-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
   ...
   "privacyDefault" : "optedin"
        ...
        <div class="aside">
            ...
            <ul>
                ...
                <li>Prod RSIDs:<br /><em>cbsicbssportsapp,cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsicbssportsapp-dev,cbsicbsiall-dev</em></li>
                <!-- <li>JIRA Ticket(s):<br /><em>https://owl.cbsi.com/jira/browse/OMNITURE-590</em></li> -->
            </ul>
        </div>
    </div>
</div>
...
',
    '[[$basicHead]]' => '    <title>CBSSports - MiMOSA</title>
