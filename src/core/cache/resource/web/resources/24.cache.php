<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1488574630,
    'editedby' => 2,
    'editedon' => 1491492176,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1488574620,
    'publishedby' => 2,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="en">
<head>    <title>CBS Sports - MiMOSA</title>
...
.line-numbers-rows > span:before { content:counter(linenumber); color:#999; display:block; padding-right:0.8em; text-align:right; }
    ...
    {{#each entry}}
    <div class="accordion2 ontology-method-{{this.gsx$trackingmethod.$t}}{{#if this.gsx$mediapartnerid.$t}}-video{{/if}}{{#if this.gsx$articleid.$t}}-article{{/if}}">
    ...
    articleAuthorName : \'{{this.gsx$articleauthorname.$t}}\'{{/if}}{{#if this.gsx$mediapartnerid.$t}}
...
<script type="text/javascript">
    ...
    jQuery(function(){
        ...
        jQuery(document).ajaxStart(function(){
            ...
            firehandlebars(feed, "#app-code-template", "#tab-ontology-basic-trackstate");
            fireaccordion(".accordion2");
            firetabs();
            fireprism();
            jQuery(\'.ontology-method-trackState\').detach().appendTo(\'#tab-ontology-basic-trackstate\');
            jQuery(\'.ontology-method-trackAction\').detach().appendTo(\'#tab-ontology-basic-trackaction\');

            jQuery(\'.ontology-method-trackState-article\').detach().appendTo(\'#tab-ontology-articles-trackstate\');
            jQuery(\'.ontology-method-trackAction-article\').detach().appendTo(\'#tab-ontology-articles-trackaction\');

            jQuery(\'.ontology-method-trackState-video\').detach().appendTo(\'#tab-ontology-video-trackstate\');
            jQuery(\'.ontology-method-trackAction-video\').detach().appendTo(\'#tab-ontology-video-trackaction\');
...
<li class="active"><a href="groups/" title="Groups" class=\'linkdisable\'>Groups</a><ul><li class="first active"><a href="cdm/" title="CDM" class=\'linkdisable\'>CDM</a><ul><li class="first active"><a href="sports/" title="Sports" >Sports</a><ul><li class="first active"><a href="cbs-sports/" title="CBS Sports" >CBS Sports</a></li>
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>CBS Sports</h2>
            <p>This is basic tracking information related to CBS Sports -</p>
            <h3>Web</h3>
<ul>
    <li><h4>CBSSports.com</h4></li>
    <ul>
        <li><h5>Web</h5>
            <ul>
                <li>AAM - Yes</li>
                <li>HTTPS Enabled - No</li>
                <li>Omniture Version - JS-1.6</li>
                <li>Tealium Profile - cbssportssite</li>
            </ul>
        </li>
...
<h3>Apps</h3>
<ul>
    <li><h4>CBSSports</h4></li>
    <ul>
        
        <li><h5>Android</h5>
            <ul>
                <li>AAM - Yes</li>
                <li>App Version - CBS Sports 9.3.1 (204)</li>
                <li>HTTPS Enabled - No</li>
                <li>Last Update - </li>
                <li>App Link - </li>
                <li>SDK Version - JAVA-4.5.3-AN</li>
            </ul>
            <h5>iOS</h5>
            <ul>
                <li>AAM - Yes</li>
                <li>App Version - CBS Sports 10.1 (1701261117)</li>
                <li>HTTPS Enabled - No</li>
                <li>Last Update - </li>
                <li>App Link - </li>
                <li>SDK Version - OIP-4.8.6</li>
            </ul>
        </li>
    </ul>
</ul>
        ...
        <div class="aside">
            ...
            <ul><li class="first">Web<ul><li class="first"><a href="cbssports.com-website.html" title="CBSSports.com" >CBSSports.com</a></li>
</ul></li>
<li class="last">Apps<ul><li class="first"><a href="cbs-sports-app.html" title="CBSSports" >CBSSports</a></li>
</ul></li>
</ul>
        </div>
    </div>
...
cdata.put("articleAuthorName", "{{this.gsx$articleauthorname.$t}}");{{/if}}{{#if this.gsx$mediapartnerid.$t}}
...
<script type="text/javascript">
    ...
    '[[$basicHead]]' => '    <title>CBS Sports - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
    ...
    '[[getResourceField? &id=`55`]]' => 'Web',
    '[[If? &subject=`Web` &operator=`EQ` &operand=`Web` &then=`
        <li><h5>Web</h5>
            <ul>
                <li>AAM - Yes</li>
                <li>HTTPS Enabled - No</li>
    ...
    '[[If? &subject=`Web` &operator=`EQ` &operand=`Apps` &then=`
        <li>
            
        </li>`]]' => '',
    '[[getResources? &parents=`55` &depth=`0` &tpl=`installationDetails_level5` &includeTVs=`1`]]' => '<ul>
    <li><h4>CBSSports.com</h4></li>
    <ul>
        <li><h5>Web</h5>
            <ul>
    ...
    '[[getResourceField? &id=`8`]]' => 'Apps',
    '[[If? &subject=`Apps` &operator=`EQ` &operand=`Web` &then=`
        <li><h5>Web</h5>
            <ul>
                <li>AAM - </li>
                <li>HTTPS Enabled - </li>
                <li>Omniture Version - </li>
                <li>Tealium Profile - </li>
            </ul>
        </li>`]]' => '',
    '[[If? &subject=`Apps` &operator=`EQ` &operand=`Apps` &then=`
        <li><h5>Android</h5>
            <ul>
                <li>AAM - Yes</li>
                <li>App Version - CBS Sports 9.3.1 (204)</li>
    ...
    '[[getResources? &parents=`8` &depth=`0` &tpl=`installationDetails_level5` &includeTVs=`1`]]' => '<ul>
    <li><h4>CBSSports</h4></li>
    <ul>
    ...
    '[[getResources? &parents=`24` &depth=`0` &debug=`1` &tpl=`installationDetails_level4`]]' => '<h3>Web</h3>
<ul>
    <li><h4>CBSSports.com</h4></li>
    <ul>
        <li><h5>Web</h5>
...
<ul>
    ...
    '[[Wayfinder? &startId=`24` &level=`2` &parentRowTpl=`li_noLink`]]' => '<ul><li class="first">Web<ul><li class="first"><a href="cbssports.com-website.html" title="CBSSports.com" >CBSSports.com</a></li>
</ul></li>
<li class="last">Apps<ul><li class="first"><a href="cbs-sports-app.html" title="CBSSports" >CBSSports</a></li>
</ul></li>
</ul>',
