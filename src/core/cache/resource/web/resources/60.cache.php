<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 7,
    'createdon' => 1492698199,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1492683046,
    'publishedby' => 7,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'prodrsids',
      1 => 'cnetzdnetglobalsite, cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cnetzdnetglobalsite-dev, cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>ZDnet.com - MiMOSA</title>
...
.line-numbers-rows > span:before { content:counter(linenumber); color:#999; display:block; padding-right:0.8em; text-align:right; }
    ...
    siteCode : \'zdnet\'
    sitePrimaryRsid : \'cnetzdnetglobalsite\'
...
<li class="last active"><a href="cmg/" title="CMG" class=\'linkdisable\'>CMG</a><ul><li class="first active"><a href="b2b/" title="b2b" class=\'linkdisable\'>b2b</a><ul><li class="first"><a href="techrepublic/" title="TechRepublic" >TechRepublic</a></li>
<li class="last active"><a href="zdnet/" title="ZDNet" >ZDNet</a></li>
</ul></li>
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>ZDnet.com</h2>
            <p>This is the tracking spec for ZDnet.com using the latest tracking implementation for -</p>
            <ul>
                <li>Web</li>
...
&lt;/script&gt;
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>siteCode</td>
                                        <td>This key should always be set to the value "zdnet"</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>The value will be either "cnetzdnetglobalsite" or "cnetzdnetglobalsite-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
    ...
    screenName": "[screenName]"
        ...
        <div class="aside">
            ...
            <ul>
                <li>Site Code:<br /><em>zdnet</em></li>
                <li>Site Type:<br /><em>desktop web</em></li>
                <li>Prod RSIDs:<br /><em>cnetzdnetglobalsite, cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cnetzdnetglobalsite-dev, cbsicbsiall-dev</em></li>
                <!--  -->
            </ul>
        </div>
    </div>
...
<pre class="line-numbers"><code class="language-java">cdata.put("siteCode", "zdnet");
cdata.put("sitePrimaryRsid", "cnetzdnetglobalsite");
...
',
    '[[$basicHead]]' => '    <title>ZDnet.com - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cnetzdnetglobalsite, cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
...
[ADBMobile trackState:@"screenName", data:cdata];</code></pre></div>',
    '[[$base_codeFormat_android]]' => '<div id="tab102" class="tab"><h3 style="margin:0;">Android Data Object</h3><pre class="language-java line-numbers"><code class="language-java">cdata.put("siteCode", "zdnet");
cdata.put("sitePrimaryRsid", "cnetzdnetglobalsite");
cdata.put("siteType", "desktop web");
