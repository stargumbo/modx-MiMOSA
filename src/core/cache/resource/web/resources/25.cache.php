...
<html lang="en">
<head>    <title>CBS Sports Fantasy - MiMOSA</title>
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>CBS Sports Fantasy</h2>
            <p>This is basic tracking information related to CBS Sports Fantasy -</p>
            <h3>Apps</h3>
<ul>
    <li><h4>CBS Sports Fantasy App</h4></li>
    <ul>
...
<ul>
    ...
    <ul>
        ...
        <div class="aside">
            ...
            <ul><li class="first">Apps<ul><li class="first"><a href="cbssportsfantasy-app.html" title="CBS Sports Fantasy App" >CBS Sports Fantasy App</a></li>
...
<script type="text/javascript">
    ...
    '[[$basicHead]]' => '    <title>CBS Sports Fantasy - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
    ...
    '[[getResources? &parents=`38` &depth=`0` &tpl=`installationDetails_level5` &includeTVs=`1`]]' => '<ul>
    <li><h4>CBS Sports Fantasy App</h4></li>
    <ul>
...
<ul>
    ...
    '[[getResources? &parents=`25` &depth=`0` &debug=`1` &tpl=`installationDetails_level4`]]' => '<h3>Apps</h3>
<ul>
    <li><h4>CBS Sports Fantasy App</h4></li>
    <ul>
...
<ul>
    ...
    '[[Wayfinder? &startId=`25` &level=`2` &parentRowTpl=`li_noLink`]]' => '<ul><li class="first">Apps<ul><li class="first"><a href="cbssportsfantasy-app.html" title="CBS Sports Fantasy App" >CBS Sports Fantasy App</a></li>
<li class="last"><a href="draftmaster-app.html" title="DraftMaster App" >DraftMaster App</a></li>
</ul></li>
</ul>',
  ),
