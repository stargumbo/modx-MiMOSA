...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>ZDNet</h2>
            <p>This is basic tracking information related to ZDNet -</p>
            <h3>Web</h3>
<ul>
    <li><h4>ZDnet.com</h4></li>
    <ul>
        <li><h5>Web</h5>
            <ul>
                <li>AAM - Yes</li>
                ...
                <li>Tealium Profile - zdnetglobalsite</li>
            </ul>
        </li>
        ...
        <div class="aside">
            ...
            <ul><li class="first">Web<ul><li class="first"><a href="zdnet.com.html" title="ZDnet.com" >ZDnet.com</a></li>
</ul></li>
</ul>
        </div>
    </div>
...
',
    '[[$basicHead]]' => '    <title>ZDNet - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
    ...
    '[[getResources? &parents=`59` &depth=`0` &tpl=`level5_installationDetails` &includeTVs=`1`]]' => '<ul>
    <li><h4>ZDnet.com</h4></li>
    <ul>
        <li><h5>Web</h5>
            <ul>
    ...
    '[[getResources? &parents=`41` &depth=`0` &debug=`1` &tpl=`level4_installationDetails`]]' => '<h3>Web</h3>
<ul>
    <li><h4>ZDnet.com</h4></li>
    <ul>
        <li><h5>Web</h5>
    ...
    '[[Wayfinder? &startId=`41` &level=`2` &parentRowTpl=`li_noLink`]]' => '<ul><li class="first">Web<ul><li class="first"><a href="zdnet.com.html" title="ZDnet.com" >ZDnet.com</a></li>
</ul></li>
</ul>',
  ),
  'sourceCache' => 
