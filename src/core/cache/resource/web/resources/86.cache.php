<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 4,
    'createdon' => 1493397516,
    'editedby' => 2,
    'editedon' => 1493411273,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1493408160,
    'publishedby' => 4,
    ...
    array (
      0 => 'gen_ontologyID',
      1 => '1d54pHIgLJFG-0ajstZonT_rvtkPF2AGq9luyjnGFFHY',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsi247sportssite, cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsi247sportssite-dev, cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>247Sports Site - MiMOSA</title>
...
.line-numbers-rows > span:before { content:counter(linenumber); color:#999; display:block; padding-right:0.8em; text-align:right; }
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p>Along with the visitor ID, we will need to append <em>cbsi247sportssite</em> to the apprsid parameter in the URL.</p>
                    <p><strong>Webview Embed URL -</strong><br />{{contains this.gsx$webviewurl.$t}}adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsi247sportssite</p>
                </div>
                {{else}}
    ...
    "siteCode" : "247sports"
    "sitePrimaryRsid" : "cbsi247sportssite"
    "siteType" : "responsive web"{{#if this.gsx$pagetype.$t}}
...
<script type="text/javascript">
    // JSON feed
    var feed = "";
    var url = "https://spreadsheets.google.com/feeds/list/1d54pHIgLJFG-0ajstZonT_rvtkPF2AGq9luyjnGFFHY/od6/public/values?alt=json";
...
<li class="last active"><a href="247sports/" title="247Sports" >247Sports</a></li>
</ul></li>
...
<div class="content">
    <div class="container">
        <div class="main">
[[@RESOURCE 92]]
            <h2>247Sports Site</h2>
            <p>This is the tracking spec for 247Sports Site using the latest tracking implementation for -</p>
            <ul>
                <li>Web</li>
...
&lt;/script&gt;
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>siteCode</td>
                                        <td>This key should always be set to the value "247sports"</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>siteType</td>
                                        <td>This key should be set to "responsive web" to indicate that this tracking is occurring within mobile apps</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>sitePrimaryRsid</td>
                                        <td>The value will be either "cbsi247sportssite" or "cbsi247sportssite-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsi247sportssite, cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
   ...
   "privacyDefault" : "optedin"
                    ...
                    <p>For production environment, change rsids to "cbsi247sportssite, cbsicbsiall"</p>
                    <p>All test builds should use "cbsi247sportssite-dev, cbsicbsiall-dev"</p>
                </div>
                ...
                <div class="inner-container">
                    ...
                    <p>Refer to the Analytics section of the SDK doc (
        ...
        <div class="aside">
            ...
            <ul>
                <li>Site Code:<br /><em>247sports</em></li>
                <li>Site Type:<br /><em>responsive web</em></li>
                <li>Prod RSIDs:<br /><em>cbsi247sportssite, cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsi247sportssite-dev, cbsicbsiall-dev</em></li>
                <!--  -->
            </ul>
        </div>
    </div>
...
<pre class="line-numbers"><code class="language-objectivec">NSDictionary *cdata = @{
    @"siteCode": @"247sports",
    @"sitePrimaryRsid": @"cbsi247sportssite",
    @"siteType": @"responsive web",{{#if this.gsx$sitesection.$t}}
    @"pageType": @"{{this.gsx$pagetype.$t}}",{{/if}}{{#if this.gsx$pagename.$t}}
    @"pagename": @"{{this.gsx$pagename.$t}}",{{/if}}{{#if this.gsx$screenname.$t}}
    @"screenZname": @"{{this.gsx$screenname.$t}}",{{/if}}{{#if this.gsx$pageviewguid.$t}}
    @"pageViewGuid": @"{{this.gsx$pageviewguid.$t}}",{{/if}}{{#if this.gsx$clicktext.$t}}
...
<pre class="line-numbers"><code class="language-java">cdata.put("siteCode", "247sports");
cdata.put("sitePrimaryRsid", "cbsi247sportssite");
cdata.put("siteType", "responsive web");{{#if this.gsx$pagetype.$t}}
...
',
    '[[$basicHead]]' => '    <title>247Sports Site - MiMOSA</title>
...
[ADBMobile trackState:@"screenName", data:cdata];</code></pre></div>',
    '[[$base_codeFormat_android]]' => '<div id="tab102" class="tab"><h3 style="margin:0;">Android Data Object</h3><pre class="language-java line-numbers"><code class="language-java">cdata.put("siteCode", "247sports");
cdata.put("sitePrimaryRsid", "cbsi247sportssite");
cdata.put("siteType", "responsive web");
