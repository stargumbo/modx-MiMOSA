<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1499440635,
    'editedby' => 2,
    'editedon' => 1499443138,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1499440620,
    'publishedby' => 2,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'gen_ontologyID',
      1 => '1C5gYHrR65eFN0jmnF2UoTMC1T8Rk3SpBjvQsNAjPQgY',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'prodrsids',
      1 => 'cbsicbssportssite, cbsicbsiall',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'devrsids',
      1 => 'cbsicbssportssite-dev, cbsicbsiall-dev',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="en">
<head>    <title>OPM / OPC Desktop - MiMOSA</title>
...
.line-numbers .line-numbers-rows {
        ...
        <div class="inner-container2 container-{{@index}}">
            <div class="tabs">
                ...
                <div class="tab-content webview-content">
                    ...
                    <p>Along with the visitor ID, we will need to append <em>cbsicbssportssite</em> to the apprsid parameter in the URL.</p>
                    <p><strong>Webview Embed URL -</strong><br />{{contains this.gsx$webviewurl.$t}}adobe_mc=[APPENDED VISITOR ID]&amp;apprsid=cbsicbssportssite</p>
                </div>
                {{else}}
    ...
    "siteCode" : "cbssports"
    "sitePrimaryRsid" : "cbsicbssportssite"
    "siteType" : "desktop web"{{#if this.gsx$pagetype.$t}}
...
<script type="text/javascript">
    // JSON feed
    var feed = "";
    var url = "https://spreadsheets.google.com/feeds/list/1C5gYHrR65eFN0jmnF2UoTMC1T8Rk3SpBjvQsNAjPQgY/od6/public/values?alt=json";
...
<div class="content">
    <div class="container">
        <div class="main">
            <h2>OPM / OPC Desktop</h2>
            <p>This is the tracking spec for OPM / OPC Desktop using the latest tracking implementation for -</p>
            <ul>
                <li>Web</li>
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>siteType</td>
                                        <td>This key should be set to "desktop web" to indicate that this tracking is occurring within mobile apps</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>sitePrimaryRsid</td>
                                        <td>The value will be either "cbsicbssportssite" or "cbsicbssportssite-dev" depending on the environment.  Suggest deriving the value for this based on the rsid key in the ADBMobileConfig.json file.</td>
                                    </tr>
                                    <tr>
    ...
    screenName": "[screenName]"
        ...
        <div class="aside">
            ...
            <ul>
                ...
                <li>Site Type:<br /><em>desktop web</em></li>
                <li>Prod RSIDs:<br /><em>cbsicbssportssite, cbsicbsiall</em></li>
                <li>Dev RSIDs:<br /><em>cbsicbssportssite-dev, cbsicbsiall-dev</em></li>
                <!--  -->
            </ul>
        </div>
    </div>
...
<pre class="line-numbers"><code class="language-objectivec">NSDictionary *cdata = @{
    @"siteCode": @"cbssports",
    @"sitePrimaryRsid": @"cbsicbssportssite",
    @"siteType": @"desktop web",{{#if this.gsx$sitesection.$t}}
    @"pageType": @"{{this.gsx$pagetype.$t}}",{{/if}}{{#if this.gsx$pagename.$t}}
    @"pagename": @"{{this.gsx$pagename.$t}}",{{/if}}{{#if this.gsx$pageviewguid.$t}}
    @"pageViewGuid": @"{{this.gsx$pageviewguid.$t}}",{{/if}}{{#if this.gsx$clicktext.$t}}
    @"clickText": @"{{this.gsx$clicktext.$t}}",{{/if}}{{#if this.gsx$sitehier.$t}}
...
cdata.put("sitePrimaryRsid", "cbsicbssportssite");
cdata.put("siteType", "desktop web");{{#if this.gsx$pagetype.$t}}
...
',
    '[[$basicHead]]' => '    <title>OPM / OPC Desktop - MiMOSA</title>
...
<li class="last"><a href="docsclasslinkdisable/" title="Docs" class=\'linkdisable\'>Docs</a><ul><li class="first"><a href="https://docs.google.com/spreadsheets/d/1pZrw5CPZixbBxDsSB7ePCecZQm7Hanyg9J3SKJyEybI/edit#gid=3222535" title="CBSi Omniture Variables 2016" target="_blank">CBSi Omniture Variables 2016</a></li>
 ...
 "version" : "1.0",
 "analytics" : {
   "rsids" : "cbsicbssportssite, cbsicbsiall",
   "server" : "om.cbsi.com",
   "charset" : "UTF-8",
   "ssl" : false,
...
cdata.put("sitePrimaryRsid", "cbsicbssportssite");
cdata.put("siteType", "desktop web");
cdata.put("siteSection", "project|channel|product/event|service level|feature|sub-feature");
cdata.put("siteHier", "project|channel|product/event|service level|feature|sub-feature");
cdata.put("pageType", "[pageType]");
