<?php  return array (
  ...
  'access_grid_empty' => 'No ACLs to display',
  'access_grid_paginate' => 'Displaying ACLs {0} - {1} of {2}',
  ...
  'access_permissions_documents_tab' => 'Here you can see which document groups have been set up. You can also create new groups, rename groups, delete groups and see which documents are in the different groups (hover over the id of the document to see its name). To add a document to a group or remove a document from a group, edit the document directly.',
  ...
  'access_source_err_ae' => 'An ACL for that Media Source already exists.',
  ...
  'namespace_add' => 'Add Namespace',
  'access_namespace_update' => 'Update Namespace Access',
  'access_namespace_remove' => 'Remove Namespace Access',
  ...
  'user_group_namespace_access' => 'Namespace access',
  'user_group_namespace_access_desc' => 'Here you can set which Namespaces this User Group can access.',
);